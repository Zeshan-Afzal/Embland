        ...
        <div className=" max-w-6xl mx-auto flex justify-between items-center ">
          <Link to="/">
            <h1 className="font-bold text-sm sm:text-2xl mr-2">
              <span className="text-red-500">Emb</span>
          ...
          <ul className=" flex gap-4  items-center ">
            ...
            <Link to="/profile">
              {currentUser ? (
                ...
                <li className=" cursor-pointer hover:bg-blue-400 hover:text-white transition-all duration-200 bg-blue-100 border border-blue-500 text-blue-500 md:p-2 w-20 p-1 mr-2 rounded-lg   md:w-36 text-center  ">
                  Sing In
                </li>
              )}
            </Link>
          ...
          <IoMenu className="sm:hidden cursor-pointer text-xl" />
        </div>
        {/* <SideBar></SideBar> */}
      </header>
    </>
